...
Preliminary quality flags were assigned to the data based on the difference between replicates. Thresholds for flag 3 and 4 were set for each nutrient type, and if poor replication was above a threshold, both replicates received the same flag of 3 or 4. A limited number of samples were evaluated by the data provider and converted to a different flag as needed. Due to the preliminary nature of the current flagging scheme, no data have been removed from the data set at this time. Future manually checked versions of flagging will possibly replace values with NA.
...
Sosik, H.M., E. Crockford, and E. Peacock. 2024. Dissolved inorganic nutrients from the Martha's Vineyard Coastal Observatory (MVCO), including 4 macro-nutrients from water column bottle samples, ongoing since 2003 (NES-LTER since 2017) ver 5. Environmental Data Initiative. https://doi.org/10.6073/pasta/a5a26fe8dd8ac113641869fe1376da4b (Accessed 2026-05-28).
