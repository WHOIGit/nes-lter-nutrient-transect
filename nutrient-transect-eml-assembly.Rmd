...
AR52ooi <- AR52ooi |> 
  select(cruise, cast, niskin, start_latitude_degrees, start_longitude_degrees, date_time_utc, ctd_depth_m) |>
  rename(latitude = start_latitude_degrees) |>
  rename(longitude = start_longitude_degrees) |>
  rename(depth = ctd_depth_m)
  
# get nutrient values from API
ar52_url <- glue::glue('{base_api_url}nut/ar52_nutrient_samplelog')
...
all_cruises <- full_join(all_cruises, AR52)
