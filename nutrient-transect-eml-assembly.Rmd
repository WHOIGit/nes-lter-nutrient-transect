...
if (!file.exists("nes-lter-nutrient-transect.csv")) {
  ...
  all_cruises <- all_cruises[,c("cruise", "cast", "niskin", "date", "latitude", "longitude", 
                              "depth", "sample_id", "replicate", "nitrate_nitrite", "ammonium", "phosphate", "silicate")]
...
Redacted code which pulls in the nearest station for each sample.
```{r}
...
#     
#     # bind the next cruise to the compiled cruise dataset
#     all_cruises <- rbind.fill(prev_all, next_all)
#     
#     # if statment to reset the previous cruises until all cruises are read in
#       if(k < length(cruiselist)) {
