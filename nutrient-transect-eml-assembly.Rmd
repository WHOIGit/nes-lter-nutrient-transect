...
author: "Stace Beaulieu, Jaxine Wolfe, and Joe Futrelle"
date: "2021-12-07"
...
all_cruises <- all_cruises %>% filter(project_id != "OOI")
...
all_cruises$sample_id[is.na(all_cruises$sample_id)] <- "NaN"
all_cruises$alternate_sample_id[is.na(all_cruises$alternate_sample_id)] <- "NaN"

all_cruises <- all_cruises[order(all_cruises$date), ]

# write csv
write.csv(all_cruises, "nes-lter-nutrient-transect.csv", row.names = FALSE, quote = FALSE)
